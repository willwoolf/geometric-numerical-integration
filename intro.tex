...
Since there is a mixed $tx$ term, this is a nonlinear equation.
...
If we want to improve the order at which error decreases, we may start by considering a Runge-Kutta (RK) method.
